...
// by + or -, once their sum reaches below zero it prints out "Sum is below
// zero." You need to verify if the character entered is a number or not, and if
// the sign is '+'' or '-'. If not, the user is asked to re-enter till a valid
// input is
// taken.
int main(void) {
  char userChar;
